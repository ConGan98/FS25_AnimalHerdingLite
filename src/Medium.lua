...
local files = {
	...
	"animals/PersonalityJitter.lua",
	"animals/CalmBehaviorCycler.lua",
	"animals/AnimalSounds.lua",
	...
	"AnimalManager.lua",
	"DogPassengerMesh.lua",
	"DogPassengerOffsets.lua",
	"DogHerding.lua",
	"events/DogHerdingRequestEvent.lua",
	"events/DogPassengerEvent.lua",
	"FSBaseMission.lua",
